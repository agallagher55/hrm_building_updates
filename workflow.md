...
|---|---|---|---|
| `BLD_building_assetpoint` | TASK0326632 (see `workstreams/bld_asset_point/bld_asset_point.md`) | `changes/Add fields to Building Assetpoint.xlsx` | Nothing, but gates the row below |
...
**Now tracked in its own file: `workstreams/bld_asset_point/bld_asset_point.md`** (moved out since this became the priority workstream). Ticket record (ServiceNow fields, full description) in `tickets/TASK0326632.md`. This file keeps only the ticket summary row above and the related/dependent tickets below.

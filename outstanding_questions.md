...
4. ~~RMLIFE auto-calculation (INSTYR + BASELIFE)~~ — implement as an attribute rule rather than a manual field or schema-level calculation. Not a blocker to the field add/rename itself.
5. ~~ROLLUPID auto-calculation (from BL_ID / Land ID)~~ — implement as an attribute rule, same as RMLIFE.
